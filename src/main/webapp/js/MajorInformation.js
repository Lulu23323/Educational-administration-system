...
$(function(){
    ...
    $(document).on("click",".addButton_ok",function(){
        ...
        var str='<tr class="trHover">' +
            ...
            '<td class="majId">'+arrAdd[0]+'</td>' +
            '<td class="majName">'+arrAdd[1]+'</td>' +
            '<td class="majAcademy">'+arrAdd[2]+'</td>' +
            '<td class="majIntroduction">'+arrAdd[3]+'</td>' +
    ...
    $(document).on("click",".updatabtn_ok",function(){
        ...
        $.ajax({
            type:"POST",
            url:"/2009/updateMajorServlet", //提交修改专业的网址
            data:{
             "major_id":arrMove[0],
             "major_name":arrMove[1],
             "major_aca":arrMove[2],
             "major_intro":arrMove[3]
             
            },//提交的数据
            success:function(res){
                console.log("传送修zhuanye数据成功");
                console.log(res);
            },
            error:function(){
                alert("向后台传输修改专业数据出错");
    ...
    $(function(){
        ...
        $("#deleteButton").click(function() {
            ...
            $("input:checked").each(function() { // 遍历选中的checkbox
            	...
            	delMajorID.push(delP.find(".majId").text());            	
            ...
            $.ajax({
	                type:"POST",
	                url:"/2009/deleteMajorServlet", //提交删除专业的网址
	                data:{
	                	"delMajorID":delMajorID.join(",")
	                },//提交的数据
	                success:function(res){
	                    console.log("传送删除专业id成功");
	                    console.log(res);
	                },
	                error:function(){
	                    alert("向后台传输删除专业id出错");
