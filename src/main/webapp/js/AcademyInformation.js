...
$(function(){
    ...
    $(document).on("click",".addButton_ok",function(){
        ...
        var str='<tr class="trHover">' +
            ...
            '<td class="acaId">'+arrAdd[0]+'</td>' +
            '<td class="acaName">'+arrAdd[1]+'</td>' +
            '<td class="acaIntroduction">'+arrAdd[2]+'</td>' +
    ...
    $(document).on("click",".updatabtn_ok",function(){
        ...
        $.ajax({
            type:"POST",
            url:"/2009/updateCollegeServlet", //提交修改学院的网址
            data:{
             "aca_id":arrMove[0],
             "aca_name":arrMove[1],
             "aca_intro":arrMove[2]
...
                console.log("传送修xueyuan数据成功");
                console.log(res);
            },
            error:function(){
                alert("向后台传输修改xueyuan数据出错");
            }
        })   
    ...
    $(function(){
        ...
        $("#deleteButton").click(function() {
            ...
            $("input:checked").each(function() { // 遍历选中的checkbox
            	...
            	delAcademyID.push(delP.find(".acaId").text());            	
            ...
            $.ajax({
	                type:"POST",
	                url:"/2009/deleteCollegeServlet", //提交删除学院的网址
	                data:{
	                	"delAcademyID":delAcademyID.join(",")
	                },//提交的数据
	                success:function(res){
	                    console.log("传送删除学院id成功");
	                    console.log(res);
	                },
	                error:function(){
	                    alert("向后台传输删除学院id出错");
